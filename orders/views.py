...
def payments(request):
    ...
    # store transaction detail with Payment models
    payment = Payment(
        user=request.user,
...
def place_order(request, total=0, quantity=0):
    ...
    # if card count is less than or equal to 0, then redirect back to shop
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Srore all the billing information inside order table
            data = Order()
